...
echo ""
echo -e "  ${YELLOW}1.${NC} Fetch cookies for your cluster:"
echo -e "     ${GREEN}cd ${MCP_WRAPPER_DIR}${NC}"
echo -e "     ${GREEN}./get-cookies.py --list${NC}                    # See available clusters"
echo -e "     ${GREEN}./get-cookies.py prod-azure-us-cdp${NC}         # Fetch cookies (opens browser)"
echo ""
echo -e "  ${YELLOW}2.${NC} (Optional) Update cluster URL in .mcp.json if needed:"
echo -e "     ${GREEN}nano ${MCP_JSON}${NC}"
echo ""
echo -e "  ${YELLOW}3.${NC} Start Claude Code:"
echo -e "     ${GREEN}cd ${PROJECT_ROOT}${NC}"
echo -e "     ${GREEN}claude${NC}"
echo ""
echo -e "  ${YELLOW}4.${NC} Try it out:"
echo -e "     Ask Claude: ${BLUE}\"Search for errors in the last 10 minutes\"${NC}"
echo ""
echo -e "${YELLOW}Note:${NC} If you change clusters, run ${GREEN}./get-cookies.py <cluster-name>${NC}"
echo -e "      No Claude Code restart needed!"
echo ""
